...
```
That's all! Now in admin interface we have fields to download unlimited images associated with ``Post`` model. Each field has ``LINK TO PASTE`` value to provide to your WYSIWYG editor. Fields also have thumbnail and delete checkboxes for convenient way for managing images.
